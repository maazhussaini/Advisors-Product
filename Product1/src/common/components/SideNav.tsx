  ...
  return (
    ...
    >
      ...
      <nav className="flex flex-col space-y-4 ">
        ...
        {/* <a
          href="#"
          className="flex items-center text-white text-lg font-medium hover:text-blue-400"
        >
          <svg className="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 24 24">
            <path d="M4 13h6v6H4v-6zM4 4h6v6H4V4zM13 4h6v6h-6V4zM13 13h6v6h-6v-6z"></path>
          </svg>
        ...
        <a
          href="#"
          className="flex items-center text-blue-400 text-lg font-medium"
        >
          <svg className="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 24 24">
            <path d="M4 13h6v6H4v-6zM4 4h6v6H4V4zM13 4h6v6h-6V4zM13 13h6v6h-6v-6z"></path>
          </svg>
...
<div className="mt-auto pt-6 border-t border-gray-700">
  ...
  <img src='setting.svg' alt="logout" />
